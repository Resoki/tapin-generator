<template>
  ...
  export default {
    ...
    props: {
      allAvisTab: Array,
      isOpenAvisList: Boolean
    },
    data() {
    return {
      displayedAvis: [],
      numAvisToDisplay: 3, // Change this value to control how many avis to display initially
      isOpenAvis: false
    };
  },
    methods: {
  ...
  margin-top: 10px;
  color: white;
  word-wrap: break-word; /* Cela permettra au texte de passer à la ligne */
}
